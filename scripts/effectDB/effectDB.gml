...
DESCRIPTION =  9; //FUNCTIONALITY of effect (?)
#endregion
...
effect[0, DESCRIPTION] = "Burning for " + string(effect[0, VALUE]) + " damage a turn.";
...
effect[2, DESCRIPTION] = "Burning for " + string(effect[2, VALUE]) + " damage a turn.";
...
effect[3, DESCRIPTION] = "Burning for " + string(effect[3, VALUE]) + " damage a turn.";
...
effect[4, DESCRIPTION] = "Burning for " + string(effect[4, VALUE]) + " damage a turn.";
...
effect[5, DESCRIPTION] = "Burning for " + string(effect[5, VALUE]) + " damage a turn.";
...
effect[6, DESCRIPTION] = "Burning for " + string(effect[6, VALUE]) + " damage a turn.";
