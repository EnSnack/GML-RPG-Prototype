...
EFFECT     = 5; //EFFECT of spell
EFFECTATTR = 6; //ATTRIBUTE of EFFECT of spell
EFFECTVAL  = 7; //VALUE of EFFECT of spell
TARGET     = 8; //TARGET of spell, 0 = one ally, 1 = all allies, 2 = one enemy, 3 = all enemies, 4 = everyone
#endregion
